...
#include "../../../include/gui/mainMenuWindow.hpp"
...
struct qt_meta_stringdata_CLASSMainMenuWindowENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSMainMenuWindowENDCLASS = QtMocHelpers::stringData(
    "MainMenuWindow",
    "handleLogout",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSMainMenuWindowENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject MainMenuWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSMainMenuWindowENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSMainMenuWindowENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSMainMenuWindowENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *MainMenuWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSMainMenuWindowENDCLASS.stringdata0))
